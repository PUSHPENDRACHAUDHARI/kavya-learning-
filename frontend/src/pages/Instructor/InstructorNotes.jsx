...
const InstructorNotes = () => {
  ...
  const loadNotes = async () => {
    try {
      const res = await axiosClient.get('/api/instructor/notes');
  ...
  const handleUpload = async (e) => {
    ...
    setUploading(true);
    try {
      await axiosClient.post('/api/instructor/notes', formData, {
  ...
  const handleDelete = async (id) => {
    ...
    setDeleting(id);
    try {
      await axiosClient.delete(`/api/instructor/notes/${id}`);
